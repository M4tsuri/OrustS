use super::utils::{ATTR_SEG16, ATTR_SEG32, DTType, DescriptorTable, SEGC_READ, SEGD_DOWN, SEGD_WRITE, SEG_CODE, SEG_LDT, TYPE_CD, TYPE_SYS, pack_dt, pack_selector};
...
const fn init_gdt() -> [u64; GDT_MAX_LEN] {
    ...
    gdt[3] = pack_dt(0, STACK_START, 
        SEGD_DOWN | SEGD_WRITE, TYPE_CD,
        Privilege::Ring0 as u8, 1, ATTR_SEG32, 0);
    // Video RAM
    gdt[4] = pack_dt(VIDEO_START, VIDEO_SIZE - 1, 
        SEGD_WRITE, TYPE_CD, 
        Privilege::Ring0 as u8, 1, ATTR_SEG32, 0);
    ...
    gdt[7] = pack_dt(LDT_START, LDT_SIZE - 1, 
        SEG_LDT, TYPE_SYS, 
