...
pub const CODE_END: u32 = 0x7ff00;

pub const LDT_START: u32 = CODE_END;
pub const LDT_END: u32 = 0x80000;

pub const DATA_START: u32 = LDT_END;
/// STAGE 3 ends here
pub const DATA_END: u32 = 0x98000;

pub const STACK_START: u32 = DATA_END;
pub const STACK_END: u32 = 0xb0000;
